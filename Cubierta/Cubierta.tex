...
%{\bf DISEÑO E IMPLEMENTACIÓN DE UN ESPECTRÓMETRO LINEAL EN EL NÚMERO DE ONDA
	{
		\bf DISEÑO E IMPLEMENTACIÓN DE UN ESPECTRÓMETRO LINEAL EN EL NÚMERO DE ONDA PARA TOMOGRAFÍA 
		...
		Co-director\\
		MSc. CAMILO ANTONIO CANO BARRERA \\      
		\vfill
		UNIVERSIDAD EAFIT \\
		ESCUELA DE CIENCIAS \\
		%DEPARTAMENTO DE CIENCIAS FÍSICAS \\
...
\newpage
\agradecimientos
%\addcontentsline{toc}{chapter}{\bf{Agradecimientos}\vspace*{-.5\baselineskip}}
