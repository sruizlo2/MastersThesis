		...
		\begin{center}
			{
				...
				\MakeUppercase{Computational adaptive optics in optical coherence tomography with phase unstable systems}
				\vfill
...
\newcommand\portada{
	\begin{titlepage}
		\begin{center}
			{
				{
					COMPUTATIONAL ADAPTIVE OPTICS FOR OPTICAL COHERENCE TOMOGRAPHY WITH PHASE UNSTABLE SYSTEMS
					\vfill
					SEBASTIÁN RUIZ LOPERA
					\vfill
					...
					Hardvard Medical Shcool and Massachussets General Hospital
					\vfill
					UNIVERSIDAD EAFIT \\
					SCHOOL OF SCIENCES \\
					DEPARTMENT OF PHYSICAL SCIENCES \\
...
\newcommand \aceptacion{
	\begin{flushleft}
		...
		{\vspace{1.5\baselineskip} \hspace{0.5\textwidth} \hrulefill \\}
		{\vspace{4.5\baselineskip} \hspace{0.5\textwidth} Medellín, September 2020}
	\end{flushleft}
}
